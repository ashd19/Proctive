...
export default function LandingPage() {
  ...
  const { connect, isConnected, setRole, isLoading, signer, address } =
    useWalletStore();
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div
        ...
        style={{
          backgroundImage: `radial-gradient(125% 125% at 50% 90%, #ffffff 40%, #297de3 100%)`,
          backgroundSize: "cover",
        }}
      >
        <section className="relative  h-screen pt-32 pb-20 overflow-hidden">
          {/* Background Effects */}
            ...
            <div className="text-center max-w-4xl mx-auto">
              ...
              >
                ...
                <h1 className="text-5xl md:text-7xl font-bold text-slate-900 mb-6 leading-tight">
                  ...
                  <p>
                    <ColourfulText text="Data Exchange" />
                  </p>
                </h1>
