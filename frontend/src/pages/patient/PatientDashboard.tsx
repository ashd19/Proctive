...
import { FileText, Shield, Eye, Users, Activity, TrendingUp, Loader } from 'lucide-react'
...
export default function PatientDashboard() {
  ...
  useEffect(() => {
    async function loadDashboardData() {
      if (!services.patientRecords || !services.accessControl || !services.auditLog || !address) {
        setLoading(false)
        return
      }
    ...
    <div className="p-8">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-slate-600">Welcome back! Here's your health data overview</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-slate-900 mb-1">Manage Records</h3>
                <p className="text-sm text-slate-600">Upload and view your medical records</p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">Manage who can view your records</p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">View all access to your records</p>
              </div>
            </div>
          </Link>
        </div>
              ...
              {recentActivity.map((activity, idx) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className={`p-2 rounded-lg ${activity.wasEmergency ? 'bg-amber-100' : 'bg-blue-100'}`}>
                    ...
                    <div>
                      <p className="font-medium text-slate-900">
                        Record #{activity.recordId} {activity.wasEmergency && '(Emergency)'}
                      </p>
                      <p className="text-sm text-slate-600">
                        Accessed by {activity.accessor.slice(0, 6)}...{activity.accessor.slice(-4)}
                      </p>
                    </div>
                  </div>
